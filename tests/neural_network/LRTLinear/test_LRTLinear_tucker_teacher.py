...
with torch.no_grad():
    ...
    core_factor_array=weight_factors[0].numpy()
    weight_factor_matrices_array=[f.numpy() for f in weight_factors[1]]
#print('outside', weight_factors_array[0])
weight_2=tl.tucker_to_tensor(core_factor_array,weight_factor_matrices_array)
